  ...
  const handleAprobarComentario = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        Swal.fire(
          'Aprobado',
          'El comentario ha sido aprobado.',
          'success'
        );
      }
    });
            ...
            <div key={comentario._id} className="col-md-4 mb-4">
              <div className="card p-3">
                ...
                <div className="d-flex justify-content-between">
                  <Button variant="success" onClick={() => handleAprobarComentario(comentario._id)}>Aprobar</Button>
                  <Button variant="danger" onClick={() => handleRechazarComentario(comentario._id)}>Rechazar</Button>
                </div>
              </div>
            </div>
          ))
